...
extern void ExecHashTableInsert(HashJoinTable hashtable, TupleTableSlot *slot,
                                uint32 hashvalue);
...
extern bool ExecHashGetHashValue(HashJoinTable hashtable, ExprContext *econtext,
                                 List *hashkeys, bool outer_tuple,
...
extern void ExecChooseHashTableSize(double ntuples, int tupwidth, bool useskew,
                                    ...
                                    int parallel_workers, size_t *space_allowed,
...
extern void ExecHashInitializeWorker(HashState *node,
